...
public class ChooseYourOwnAdventure
{
  ...
  private static void approachOoze()
  {
    ...
    String TextEquals = MessageBox
        .askForTextInput("Do you want to pour the ooze into the 'backyard' or 'toilet'?");
    if ("toilet".equalsIgnoreCase(TextEquals))
    {
      pourIntoToilet();
    }
    else if ("backyard".equalsIgnoreCase(TextEquals))
    {
      pourIntoBackYard();
    }
    else
  ...
  private static void pourIntoToilet()
  {
    ...
    String textInput2 = MessageBox.askForTextInput("Do you want to train to be a NINJA?  'Yes' or 'HECK YES'?");
    if ("Yes".equalsIgnoreCase(textInput2))
    {
      MessageBox
          .showMessage("Awesome dude!  You live out the rest of your life fighting crimes and eating pizza!");
    }
    else if ("HECK YES".equalsIgnoreCase(textInput2))
    {
      MessageBox
          .showMessage("Awesome dude!  You live out the rest of your life fighting crimes and eating pizza!");
    }
